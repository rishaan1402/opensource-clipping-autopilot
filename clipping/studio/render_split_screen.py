...
def create_video_split_screen(
    ...
    # When switching back to a speaker who was already active, snap directly
    # to their last position, avoiding large slide/panning motion.
    ...
    switch_blend_t0 = -1.0  # time blending started after switch
    ...
    try:
        ...
        print(f"🎬 {label} - Split-screen rendering {'(dynamic)' if is_dynamic else ''} starting...", flush=True)
        ...
        while True:
            ...
            if current_layout == "full":
                ...
                is_new_switch_split = False  # Reset flag after use
